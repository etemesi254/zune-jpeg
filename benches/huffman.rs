...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    let data = vec![
        ...
        216, 217, 218, 226, 227, 228, 229, 230, 231, 232, 233, 234, 242, 243, 244, 245, 246, 247,
        248, 249, 250,
    ];

    c.bench_function("Huffman Decoder", |b| {
        b.iter(|| test_huffman(black_box(symbols.clone()), black_box(data.clone())))
    });
}
