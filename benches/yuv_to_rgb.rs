...
fn criterion_benchmark(c: &mut Criterion) {
    c.bench_function("YUV(normal) to RGB", |b| b.iter(|| ycbcr_to_rgb(black_box(69),black_box(69),black_box(76))));
    c.bench_function("YUV(int) to RGB", |b| b.iter(|| yuv_to_rgb(black_box(69),black_box(69),black_box(69))));
    c.bench_function("YUV(tables) to RGB", |b| b.iter(|| yuv_to_rgb2(black_box(69),black_box(69),black_box(69))));
